                                ...
                                <div class='p-4 mb-4 bg-white border company-form'>
                                    ...
                                    <div class="row pt-4">
                                        <div class="col-lg-10">
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-lg-5"><label for="">Phone Number<sup style='color:red'>*</sup></label></div>
                                    ...
                                    <div class="row pt-4">
                                        <div class="col-lg-6" style='border-right:2px solid #ddd'>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" name="p_email" class='form-control' value="User email"  placeholder='Email...'>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" name='p_phone' class='form-control' value="user naem" placeholder='Phone..'>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
