							...
							<div class="card ">
								...
								<div class="card-body">
									<div class="form-group">
										...
										<input type="text" name='company_name' value="{{$company->company_name}}" class="form-control" placeholder="Company Name @error('company_name') is-invalid @enderror" maxlength="40">
										@error('company_name')
							...
							<div class="card ">
								...
								<div class="card-body">
									<div class="form-group">
										...
										<input type="text" name='main_title' value="{{$company->main_title}}" class="form-control @error('main_title') is-invalid @enderror" placeholder="Main title" maxlength="60">
										@error('main_title')
											<div class="text-danger">{{ $message }}</div>
										@enderror
									</div>
									...
									<div class="form-group">
										...
										<textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="6" placeholder="text here.." maxlength="601">{{$company->description}}</textarea>
										@error('description')
											<div class="text-danger">{{ $message }}</div>
										@enderror
									</div>
