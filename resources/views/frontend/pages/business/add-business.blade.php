						...
						<div class="card ">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" name='name' class="form-control" placeholder="Company Name" maxlength="30">
								</div>
								<div class="form-group">
						...
						<div class="card ">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" name='main_title' class="form-control" placeholder="Main title" maxlength="42">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="description" rows="6" placeholder="text here.." maxlength="301"></textarea>
								</div>
                                <div class="form-group">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-6">
										<div class="form-group mb-0">
											...
											<input type="number" name='o_phone'  value="{{Auth::user()->phone}}" class="form-control" placeholder="Number">
										</div>
									</div>
									<div class="col-sm-6 col-md-6">
										<div class="form-group mb-0">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="input-group mb-4">
									...
									<input name='facebook' class="form-control" placeholder="Facebook URL" type="text">
								</div>
								<div class="input-group mb-4">
									<div class="input-group-text">
										<div class="input-group-text w-7 p-0 border-0 bg-transparent">
									...
									<input name='instagram' class="form-control" placeholder="Instagram URL" type="text">
								</div>
								<div class="input-group mb-4">
									<div class="input-group-text">
										<div class="input-group-text w-7 p-0 border-0 bg-transparent">
									...
									<input name='linkedin' class="form-control" placeholder="Linkedin URL" type="text">
								</div>
								<div class="input-group mb-4">
									<div class="input-group-text">
										<div class="input-group-text w-7 p-0 border-0 bg-transparent">
									...
									<input name='pinterest' class="form-control" placeholder="Pinterest URL" type="text">
								</div>
							</div>
						</div>
