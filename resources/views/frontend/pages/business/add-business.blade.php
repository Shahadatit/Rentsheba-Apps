						...
						<div class="card ">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" name='company_name' value="{{old('company_name')}}" class="form-control @error('company_name') is-invalid @enderror" placeholder="Company Name" maxlength="30">
										@error('company_name')
								...
								<div class="form-group">
									...
									<input type="text" name='c_address' value="{{old('c_address')}}" class="form-control @error('c_address') is-invalid @enderror" placeholder="Address">
									@error('c_address')
											<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
						...
						<div class="card ">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input type="text" name='main_title' value="{{old('main_title')}}" class="form-control @error('main_title') is-invalid @enderror" placeholder="Main title" maxlength="42">
									@error('main_title')
											<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
								...
								<div class="form-group">
									...
									<textarea class="form-control @error('description') is-invalid @enderror" name="description"  rows="6" placeholder="text here.." maxlength="301">{{old('description')}}</textarea>
									@error('description')
											<div class="text-danger">{{ $message }}</div>
									@enderror
								</div>
